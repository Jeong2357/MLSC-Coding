#!/usr/bin/env python3
"""
HW2: HFT Market Making via HJB — Full Pipeline
Optimal Control & RL — Evans Ch. 5 Dynamic Programming

Solves CODE-1, CODE-2, CODE-3 and generates all plots.
"""
import matplotlib
matplotlib.use('Agg')
import numpy as np
...
print("="*70)
print("HW2: HFT Market Making via HJB — Full Pipeline")
print("="*70)
...
# ================================================================
# CODE-2: HJB Oracle & Oracle PnL
# ================================================================
print("\n" + "="*70)
print("CODE-2: HJB Oracle & Oracle PnL")
print("="*70)
...
# ================================================================
# CODE-3: GRU / Mamba Student & Final Backtest
# ================================================================
print("\n" + "="*70)
print("CODE-3: GRU/Mamba Student & Backtest")
print("="*70)
